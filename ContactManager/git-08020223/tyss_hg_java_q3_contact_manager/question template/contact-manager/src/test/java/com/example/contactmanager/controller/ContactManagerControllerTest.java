...
class ContactManagerControllerTest {
	...
	ContactDto contactDto = new ContactDto(1l, "sumeet", "s@gmail.com", 9874563217l, null, null, "sumeet".getBytes());
	List<ContactDto> list = new ArrayList<>();
	ContactDetails contactDetails = new ContactDetails(1l, "sumeet", "s@gmail.com", 9874563217L, null, null,
			"sumeet".getBytes());
	...
	void getUpdateContactForm() throws Exception {
		Model model = mock(Model.class);
		mockMvc.perform(get("/showUpdateForm").flashAttr("model", model).param("email", "s@gmail.com"))
	...
	void delete() throws Exception {
		...
		mockMvc.perform(get("/delete").flashAttr("model", model).param("email", "s@gmail.com"))
	...
	@Test
	void showContactsDetails() throws Exception {
		Optional<ContactDetails> optional = Optional.of(contactDetails);
		when(service.getImageById(anyLong())).thenReturn(optional);
