...
class VehicleDetailsTest {
	...
	@Test
	void serializeTestForVehicleDetails() throws JsonProcessingException {
	...
	@Test
	void deserializeTestForVehicleDetails() throws JsonMappingException, JsonProcessingException {
